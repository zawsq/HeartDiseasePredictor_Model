...
## Dataset
The dataset used in this project is sourced from Kaggle, and it includes health-related data collected by a medical center from annual surveys conducted in the U.S. The dataset consists of three files:

- **2020 dataset**: 300k rows, 12 features.
- **2022 dataset**: Two versions (one with missing values and one without), each containing 300k rows and 36 features.
...
1. **Data Ingestion and Preprocessing**
    ...
    - **Class Imbalance**: Various techniques are applied to address the severe class imbalance, including class weights, manual and auto resampling, and SMOTE (Synthetic Minority Over-sampling Technique).
...
2. **Model Selection and Training**
    ...
    - **Best Model**: The RandomForest model performed the best, achieving:
        ...
        - 85% recall and 70% precision for individuals with heart disease, significantly improving over the baseline model.

3. **Model Deployment**
    - The final model is deployed using a Flask API, allowing users to input health data and receive heart disease predictions.
...
- **Model Deployment**: This project was not just about building a model but also about making it accessible to users. Deploying the model as an API and creating a user-friendly website demonstrated my ability to bring machine learning solutions to production.

## Future Improvements
- **Deep Learning**: Adding deep learning models, such as neural networks, could further improve performance, especially for handling complex patterns in the data.
...
Despite not having a formal degree, this project demonstrates my ability to apply professional data science practices to real-world problems, showcasing my technical skills and problem-solving abilities.

## Files and Folder Structure
- **src/**: Contains all source code, including data ingestion, transformation, and model training pipelines.
- **deployment/**: Contains the Flask API and website for deployment.
- **notebooks/**: Jupyter notebooks documenting the EDA, feature engineering, model training, and evaluation.
- **data/**: The raw and processed datasets used in the project.
